...
// PID
const double KpPitch = 17.0;  // 10 // 16 // 16 // 16
const double KdPitch = 0.8;  // 0.01 // 0.7 // 0.9 / 0.7
const double KiPitch = 150.5;  // 30 // 77 // 95 // 153

const double KpYaw = 14.0;
const double KdYaw = 0.3;
const double KiYaw = 20.02;
...
// Encoder
#define ENCA_MKI 13
#define ENCB_MKI 25 // 12
#define ENCA_MKA 33 // 14
#define ENCB_MKA 27
...
extern volatile long encoderM1, encoderM2;
